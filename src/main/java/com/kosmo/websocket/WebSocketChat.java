...
@ServerEndpoint
	: 웹소켓 서버의 요청명을 지정한다.
	주소=> ws://localhost:8081/websocket/EchoServer.do
...
public class WebSocketChat {
	...
	/*
	해당 List컬렉션은 클라이언트가 접속할 때 마다 Session 아이디를 저장하는 용도
	...
	/*
	자동으로 호출되진 않고, 서버로 메세지가 왔을 때 해당메서드를 호출한다.
